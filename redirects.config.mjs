// Single source of truth for every redirect on this site. Consumed by next.config.mjs.
//
// Two blocks:
...
export const redirects = [
  ...
  // Section landing: upstream's "Batch Poster" page was never ported. Retarget when it is.
  {

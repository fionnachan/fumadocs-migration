 ...
 * fires, including for a build whose prerendered routes never reach `getSiteUrl()`. Without it the misconfiguration surfaces as a site-wide 500 on the first request

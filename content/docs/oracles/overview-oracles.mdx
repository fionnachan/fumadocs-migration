...
description: 'Overview of blockchain oracles on Arbitrum: external data providers that supply offchain data to smart contracts. Learn how oracles work and their trust models.'

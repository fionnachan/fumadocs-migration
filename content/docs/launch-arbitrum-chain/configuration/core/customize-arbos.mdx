...
After you add a new state `myNumber` according to the guide in [customize precompile Option 5](./customize-precompile#option-5-call-and-modify-state), you also need to rewrite [`UpgradeArbosVersion`](https://github.com/OffchainLabs/{var:nitroRepositorySlug}/blob/v3.1.0/arbos/{var:nitroPathToArbosState}/arbosstate.go#L253) in [`arbosstate.go`](https://github.com/OffchainLabs/{var:nitroRepositorySlug}/blob/v3.1.0/{var:nitroPathToArbosState}/arbosstate.go):

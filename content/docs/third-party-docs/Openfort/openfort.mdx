...
The [embedded wallet](https://www.openfort.io/embedded-wallet) builds for React, React Native, Swift, and Unity SDK. It enables app developers to onboard users and generate wallets for them. Features include:

...
**Before writing a new banner, search [`content/partials/CATALOG.md`](https://github.com/OffchainLabs/Fumadocs-test/blob/main/content/partials/CATALOG.md) for one that already says what you need**, and reuse it instead of duplicating the prose. CONTRIBUTE.md's [partial-reuse guide](https://github.com/OffchainLabs/Fumadocs-test/blob/main/CONTRIBUTE.md#reuse-a-partial-before-you-write-new-prose) has the copy-paste include snippet for pulling a cataloged partial into a page.

...
1.  Begin by creating a branch (internal) or fork (external) of the Arbitrum docs repository, [`OffchainLabs/Fumadocs-test`](https://github.com/OffchainLabs/Fumadocs-test).

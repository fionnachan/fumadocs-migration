/**
 * Offline tripwire over `redirects.config.mjs`, the one redirect file, plus unit tests for the two
...
import { removeEntriesFrom, retargetDestinations, retargetRedirects } from './redirects-config.mjs';

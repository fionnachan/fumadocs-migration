...
- **Diagrams.** Concept diagrams follow the `arbitrum-brand-svg-diagrams` skill under
  `.claude/skills/`, which covers the palette, the format, and where the assets live.

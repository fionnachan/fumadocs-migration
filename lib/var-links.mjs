 ...
 *
 * Deliberately import-free apart from `node:fs`, so `scripts/lib/var-links.test.mjs` can import it
 * under `node --test` and exercise the real module rather than a copy. `scripts/lib/doc-links.mjs`
 * imports it for the same reason `scripts/lib/doc-anchors.mjs` imports `lib/mdx-options.mjs`: a

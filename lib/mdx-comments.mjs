 ...
 * its own postprocess plugin last), and because deleting these nodes is a no-op for the page
 * compile, which drops them anyway. Being in that module also means `check-links` compiles the same
